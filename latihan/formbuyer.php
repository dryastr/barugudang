 ...
 <form method="post">
    ...
    <?php
         require_once 'config.php';
            ...
            $query = "SELECT kode_buyer FROM buyer ORDER BY kode_buyer DESC LIMIT 1";
            $result = mysqli_query($conn, $query);
            $row = mysqli_fetch_assoc($result);
            $next_code = $row['kode_buyer'] + 1; // Kode masuk berikutnya

            // Menampilkan input kode masuk berikutnya
            echo '<input type="text" id="kode_buyer" name="kode_buyer" value="' . $next_code . '" readonly><br>';
        ?>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO buyer (kode_buyer, nama_buyer) VALUES ('$kode_buyer', '$nama_buyer')";
