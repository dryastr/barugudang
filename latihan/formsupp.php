...
<body id="body-pd">
  ...
  <div class="progress">
  <div class="progress-bar bg-blue" role="progressbar" style="width: 100%" aria-valuenow="22" aria-valuemin="100" aria-valuemax="100"></div>
  <div class="progress-bar bg-blue" role="progressbar" style="width: 100%" aria-valuenow="22" aria-valuemin="100" aria-valuemax="100"></div>
  <div class="progress-bar bg-blue" role="progressbar" style="width: 100%" aria-valuenow="22" aria-valuemin="100" aria-valuemax="100"></div>
</div>
...
<h2 class="w3-text-grey w3-padding-16">DATA SUPPLIER</h2>
 ...
 <form method="post">
    ...
    <?php
         require_once 'config.php';
            ...
            $next_code = $row['kode_supplier'] + 1; // Kode masuk berikutnya

            // Menampilkan input kode masuk berikutnya
            echo '<input type="text" id="kode_supplier" name="kode_supplier" value="' . $next_code . '" readonly><br>';
        ?>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO supplier (kode_supplier, nama_supplier) VALUES ('$kode_supplier', '$nama_supplier')";
