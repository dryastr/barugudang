    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> 
                ...
                <span class="nav_name">Barang 6 bulan </span> </a> <a href="#" class="nav_link"> 
    ...
    <div class="row">
        ...
        <div class="container"> 
           <div class="d-lg-flex"> <div class="card border-0 me-lg-4 mb-lg-0 mb-4"> 
            ...
            <div class="content"> <p class="h-1 mt-4">DATA ARTIKEL</p>
            <div class="d-flex align-items-center justify-content-between mt-3 pb-3"> 
            <a href="tbartikel.php"><div class="btn btn-primary">Masuk<span class="fas fa-arrow-right"></span></div></a> 
            </div> </div> </div>
                         
            <div class="d-lg-flex"> <div class="card border-0 me-lg-4 mb-lg-0 mb-4"> 
                <div class="backgroundEffect"></div><div class="content"> <p class="h-1 mt-4">DATA COLOR</p>
                      <div class="d-flex align-items-center justify-content-between mt-3 pb-3"> 
                      <a href="tbcolor.php"><div class="btn btn-primary">Masuk<span class="fas fa-arrow-right"></span></div></a>
                         </div> </div> </div>
               
            <div class="d-lg-flex"> <div class="card border-0 me-lg-4 mb-lg-0 mb-4"> 
                <div class="backgroundEffect"></div><div class="content"> <p class="h-1 mt-4">DATA RAK</p>
                      <div class="d-flex align-items-center justify-content-between mt-3 pb-3"> 
                      <a href="tbrak.php"><div class="btn btn-primary">Masuk<span class="fas fa-arrow-right"></span></div></a> 
                         </div> </div> </div></tr>
            <tr>
            <div class="container"> 
            <div class="d-lg-flex"> <div class="card border-0 me-lg-4 mb-lg-0 mb-4"> 
                <div class="backgroundEffect"></div><div class="content"> <p class="h-1 mt-4">DATA SLOT</p>
                      <div class="d-flex align-items-center justify-content-between mt-3 pb-3"> 
                      <a href="tbslot.php"><div class="btn btn-primary">Masuk<span class="fas fa-arrow-right"></span></div></a> 
                         </div> </div> </div>
                    
            <div class="d-lg-flex"> <div class="card border-0 me-lg-4 mb-lg-0 mb-4"> 
                <div class="backgroundEffect"></div><div class="content"> <p class="h-1 mt-4">DATA BUYER</p>
                      <div class="d-flex align-items-center justify-content-between mt-3 pb-3"> 
                      <a href="tbbuyer.php"><div class="btn btn-primary">Masuk<span class="fas fa-arrow-right"></span></div></a>
                         </div> </div> </div>
        
            <div class="d-lg-flex"> <div class="card border-0 me-lg-4 mb-lg-0 mb-4"> 
                <div class="backgroundEffect"></div><div class="content"> <p class="h-1 mt-4">DATA SUPPLIER</p>
                      <div class="d-flex align-items-center justify-content-between mt-3 pb-3"> 
                      <a href="tbsupplier.php"><div class="btn btn-primary">Masuk<span class="fas fa-arrow-right"></span></div></a>
                         </div> </div> </div>
</div>        
</tr>
</table>
