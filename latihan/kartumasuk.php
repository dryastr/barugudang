...
<body id="body-pd">
        ...
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> 
                ...
                <div class="nav_list"> 
                    ...
                    <a href="kartukeluar" class="nav_link"><i class='bx bx-message-square-detail nav_icon'></i> 
    ...
    <div class="content">
        <h2>Data Kartu Masuk</h2>
        <div class="mb-3">
        <a href="formmasuk.php"><button type="button" class="btn btn-primary"> Tambah Kartu</button></a>
        </div>
        <table>
            <tr>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='detailmasuk.php?id=" . $row['kode_masuk'] . "' class='btn btn-info btn-sm'>Detail</a></td>";
                    echo "</tr>";
