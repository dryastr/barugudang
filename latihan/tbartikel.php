...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> 
                ...
                <span class="nav_logo-name">PT. Globalindo Intimats</span> </a>
                ...
                <a href="#" class="nav_link"><i class='bx bx-folder nav_icon'></i>
                 ...
                 <span class="nav_name">Stats</span> </a></div></div> 
    ...
    <div class="content">
        <h2>Data Artikel</h2>
        <div class="mb-3">
        <a href="formartikel.php"><button type="button" class="btn btn-primary">Tambah Artikel</button>
        </div>
        <table>
            <tr>
                <th>Kode Artikel</th>
            ...
            $sql = "SELECT * FROM artikel 
                    INNER JOIN color on artikel.kode_color = color.kode_color
                    INNER JOIN rak on artikel.kode_rak = rak.kode_rak
                    INNER JOIN slot on artikel.kode_slot = slot.kode_slot";
