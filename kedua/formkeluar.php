    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> 
                ...
                <span class="nav_name">Kartu Keluar</span> </a> <a href="#" class="nav_link"> 
...
<h2 class="w3-text-grey w3-padding-16">KARTU KELUAR</h2>
<div class="w3-container">
<h5 class="w3-opacity"><b>isikan data dibawah ini dengan benar</b></h5>
 <form action="proses.php" method="post">
    <label for="kode-keluar">Kode Keluar:</label>
    <?php
         require_once 'config.php';
            // Query untuk mendapatkan kode masuk terakhir
            $query = "SELECT kode_keluar FROM keluar ORDER BY kode_keluar DESC LIMIT 1";
            $result = mysqli_query($conn, $query);
            $row = mysqli_fetch_assoc($result);
            $next_code = $row['kode_keluar'] + 1; // Kode masuk berikutnya

            // Menampilkan input kode masuk berikutnya
            echo '<input type="text" id="kode_keluar" name="kode_keluar" value="' . $next_code . '" readonly><br>';
        ?>
    ...
    <input type="nama_buyer" id="nama_buyer" name="nama_buyer" required>

    <label for="nama_color">Color:</label>
    <input type="nama_color" id="nama_color" name="nama_color" required>

    <label for="nama_artikel">Artikel:</label>
    <input type="text" id="nama_artikel" name="nama_artikel" required>

    <label for="unit">Unit:</label>
    <input type="unit" id="unit" name="unit" required>

    <label for="nama_supplier">Nama Supplier:</label>
    <input type="text" id="nama_supplier" name="nama_supplier" required>
    
    <label for="alokasi_style">Alokasi Style:</label>
    <textarea id="alokasi_style" name="alokasi_style" required></textarea>

    <label for="alokasi_orc">Alokasi ORC:</label>
    <input type="text" id="alokasi_orc" name="alokasi_orc" required>

    <label for="nama_rak">Rak:</label>
    <input type="text" id="nama_rak" name="nama_rak" required>
    ...
    <br><tr>
    <div class="mb-3">
    <a href="keluardua.php"><button type="button" class="btn btn-primary btn-sm">Selanjutnya</button>
    </div>
    </tr>
    </div>
</form>
