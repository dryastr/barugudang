...
<h5 class="w3-opacity"><b>isikan data dibawah ini dengan benar</b></h5>
 <form method="post">
    <label for="kodeslot">Kode Slot:</label>
    <input type="text" id="kodeslot" name="kodeslot" required>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $kodeslot = $_POST['kodeslot'];
    $nama_rak = $_POST['nama_rak'];

    // Query untuk menyimpan data ke dalam database
    $query = "INSERT INTO slotbaru (kodeslot, kode_rak) VALUES ('$kodeslot', '$nama_rak')";
